...
mkDarwin {
  ...
  buildPhase = ''
    ...
    ${cc-arch}/bin/cc_arch-darwin M2-0.c M2-0.M1
    ${catm}/bin/catm-darwin M2-0-0.M1 \
      ${root + "/M2libc/amd64/amd64_defs.M1"} \
      ${root + "/M2libc/amd64/libc-core-Darwin.M1"} \
      M2-0.M1
    ${m0}/bin/M0-darwin M2-0-0.M1 M2-0.hex2
    ...
    ${catm}/bin/catm-darwin M2-0-0.hex2 \
      ${m0}/share/darwin-bootstrap/MACHO-amd64-lowdata.hex2 \
      M2-0.hex2
    ${hex2-0}/bin/hex2-darwin M2-0-0.hex2 M2-darwin
    ${macho-patcher-early}/bin/macho-patcher m2-segments M2-0.hex2 M2-darwin
  ...
  checkPhase = ''
    ...
    cp ${root + "/stage0-posix/fixtures/m2-planet-trivial.c"} trivial.c
  ...
  meta = {
    description = "Signed Darwin Mach-O AMD64 M2-Planet candidate";
  };
}
