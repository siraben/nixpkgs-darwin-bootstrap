...
mkDarwin {
  ...
  buildPhase = ''
    ...
    ${catm}/bin/catm-darwin hex2-1-0.hex2 \
      ${m0}/share/darwin-bootstrap/MACHO-amd64-lowdata.hex2 \
      hex2_linker-0.hex2
    ${hex2-0}/bin/hex2-darwin hex2-1-0.hex2 hex2-1
    ${macho-patcher-early}/bin/macho-patcher m2-segments hex2_linker-0.hex2 hex2-1
