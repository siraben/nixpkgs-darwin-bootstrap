#!/bin/sh
## 08-m2 — assemble M2-Planet via cc_arch + M0 + hex2 + macho-patcher.
## This is the first "real build" step: it runs cc_arch on the M2 C
## source tree, M0 on the resulting .M1, hex2 on the resulting .hex2,
## then macho-patcher to fix segment vmsizes, and pads to 0x2800000.
set -eu
...
## 7) macho-patcher fixes segment vmsizes in place.
macho-patcher m2-segments M2-0.hex2 M2-darwin

## 8) Pad to LINKEDIT offset 0x2800000 = 41943040 with dd.
