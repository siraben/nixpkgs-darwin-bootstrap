...
work="$TARGET/work/tinycc-boot3-object"
rm -rf "$work"
...
tcc-boot2 -c \
  ...
  "$tinycc_src/tcc.c" \
  -o tcc-boot3.o \
  > tcc-boot3.stdout 2> tcc-boot3.stderr

test "$(od -An -tx1 -N4 tcc-boot3.o | tr -d ' \n')" = "7f454c46"
test ! -s tcc-boot3.stdout

install -d "$TARGET/share/tinycc-boot3-object"
cp tcc-boot3.o "$TARGET/share/tinycc-boot3-object/"
