...
- [ ] Bootstrap toward GCC 4.6 on Darwin.
  ...
  - [ ] Advance `make all-gcc` past libiberty.
    - Current boundary: GCC and libiberty configure succeed for `x86_64-apple-darwin`; libiberty now compiles through `fdmatch.c` and stops while compiling `fibheap.c`.
