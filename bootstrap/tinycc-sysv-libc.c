...
struct boot_stat { int st_dev; unsigned short st_mode; unsigned short st_nlink; unsigned long long st_ino; unsigned int st_uid; unsigned int st_gid; int st_rdev; struct boot_timespec st_atimespec; struct boot_timespec st_mtimespec; struct boot_timespec st_ctimespec; struct boot_timespec st_birthtimespec; long st_size; long st_blocks; int st_blksize; unsigned int st_flags; unsigned int st_gen; int st_lspare; long st_qspare[2]; };
