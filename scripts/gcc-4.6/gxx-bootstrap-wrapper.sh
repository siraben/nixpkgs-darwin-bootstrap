...
# -D__BAKE_PLAIN_STAT__: this wrapper always links with the chain tcc path
...
# bootstrap/headers/tcc-darwin-bootstrap/sys/stat.h).
cc1args=(-quiet -mno-sse3 -D__BAKE_PLAIN_STAT__ -I"$LIBSTDCXX/include" -I"$LIBSTDCXX/include/x86_64-apple-darwin" -I"$LIBSUPCXX" -isystem "$SYSROOT")
objs=()
srcs=()
