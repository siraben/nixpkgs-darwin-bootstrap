...
ALT(DEF_ASM_OP2(movhps, 0x0f17, 0, OPC_MODRM, OPT_SSE, OPT_EA | OPT_REG32 ))
    ...
    /* scalar SSE float (f3=single, f2=double) — gcc emits these for float/double */
...
ALT(DEF_ASM_OP2(cvtsi2ss, 0xf30f2a, 0, OPC_MODRM | OPC_48, OPT_EA | OPT_REG64, OPT_SSE ))
    DEF_ASM_OP2(cvtsi2sd, 0xf20f2a, 0, OPC_MODRM, OPT_EA | OPT_REG32, OPT_SSE )
ALT(DEF_ASM_OP2(cvtsi2sd, 0xf20f2a, 0, OPC_MODRM | OPC_48, OPT_EA | OPT_REG64, OPT_SSE ))
